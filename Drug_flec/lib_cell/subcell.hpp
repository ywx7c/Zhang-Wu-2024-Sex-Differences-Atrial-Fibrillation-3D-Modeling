...
class CSubcell {
        ...
        public:
                ...
                std::string ryr_map_file = "pool_ryr/male_nSR.txt";
                std::string csq_map_file = "pool_csq/male_nSR.txt";
                ...
                double get_jSR_inst_buffering(double  const & CaSR);
                
                double get_jSR_inst_buffering_simp(double const & CaSR, double local_BNCSQN)
                {
                        ...
                        double rho_BCSQN        = rho * local_BNCSQN;
                        ...
                        double rhopri_BCSQN     = rhopri * local_BNCSQN;
                        ...
                        return 1.0 / (1.0 + (kd_csqn * local_BNCSQN*ncjsr + dndc*(CaSR*kd_csqn + CaSR*CaSR)) / ((kd_csqn + CaSR) * (kd_csqn + CaSR)));
                }  

                double get_cytosol_cai_inst_buffering(double const  &Cai);
                double get_cleft_caj_inst_buffering(double const & Caj);
                double get_submem_casl_inst_buffering(double  const &casl);
                void init(double initci = 0.1, double initcj = 500, double initnai = 10, int flag_AF = 0, int flag_female = 0);
                ...
                void set_CSQ(int id, double csq_bmax);
